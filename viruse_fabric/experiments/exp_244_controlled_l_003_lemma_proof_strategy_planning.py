...
from viruse_fabric.writing.controlled_l_003_lemma_proof_strategy_planning import (
    REQUIRED_REPORT_PHRASES,
    write_report,
)


SOURCE_PATH = Path("outputs/controlled_l_002_lemma_proof_execution_v8_163.md")
OUTPUT_PATH = Path("outputs/controlled_l_003_lemma_proof_strategy_planning_v8_164.md")
...
Status: main planning completed on branch `v8-164-controlled-l-003-lemma-proof-strategy-planning`.

This milestone selects L-003 from the TC-001 lemma plan and plans a controlled L-003 proof strategy only.
...
"""
    ...
    if "## v8.164 - Controlled L-003 Lemma Proof Strategy Planning" not in existing:
        NOTE_PATH.write_text(existing.rstrip() + "\n\n" + note.strip() + "\n", encoding="utf-8")


def main() -> int:
    print("Experiment 244: Controlled L-003 Lemma Proof Strategy Planning")
    print("Question: Can Viruse Fabric select L-003 and plan a controlled proof strategy while preserving the official L-001 and L-002 proofs and keeping new L-003 proof execution, TC-001 proof, theorem proof, proof assistant verification, validation, readiness, and citations at zero?")
    print("Title: Controlled L-003 Lemma Proof Strategy Planning v8.164")
    ...
    print("Passed: True")
    print(
        "Interpretation: The v8.164 artifact selects L-003 and plans a controlled proof strategy with six planned proof steps while preserving the official L-001 and L-002 proofs and keeping new L-003 proof execution, TC-001 proof execution, theorem proof execution, proof assistant verification, validation, readiness approval, and citation claims at zero."
    )
    print("Experiment 244 completed successfully.")
    print("V8_164_CONTROLLED_L_003_LEMMA_PROOF_STRATEGY_PLANNING_OK")
    return 0
