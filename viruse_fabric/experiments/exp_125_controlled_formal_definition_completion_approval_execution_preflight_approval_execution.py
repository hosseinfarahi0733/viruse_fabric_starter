...
def main() -> None:
    ...
    print(
        "Controlled formal definition completion approval execution preflight approval execution row count:",
        report.preflight_approval_execution_row_count,
    )
    print(
        "Controlled formal definition completion approval execution preflight approval plan source row count:",
        report.preflight_approval_plan_source_row_count,
    )
    print(
    ...
    print("Experiment 125 completed successfully.")
