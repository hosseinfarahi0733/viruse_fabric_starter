...
def main() -> None:
    ...
    print(
        ...
        report.approval_execution_preflight_execution_count,
    )
    print(
        "Controlled formal definition completion approval execution preflight execution row count:",
        report.approval_execution_preflight_execution_row_count,
    )
    print(
        "Controlled formal definition completion approval execution preflight plan source row count:",
        report.approval_execution_preflight_plan_source_row_count,
    )
    print(
    ...
    print("Experiment 121 completed successfully.")
