...
from viruse_fabric.writing.controlled_m_c_definition_completion_execution import (
    REQUIRED_REPORT_PHRASES,
    write_report,
)


SOURCE_PATH = Path("outputs/controlled_pi_obs_definition_completion_execution_v8_151.md")
OUTPUT_PATH = Path("outputs/controlled_m_c_definition_completion_execution_v8_152.md")
...
"""
    ...
    if "## v8.152 — Controlled M_c Definition Completion Execution" not in existing:
        NOTE_PATH.write_text(existing.rstrip() + "\n\n" + note.strip() + "\n", encoding="utf-8")


def main() -> int:
    print("Experiment 232: Controlled M_c Definition Completion Execution")
    print("Question: Can Viruse Fabric complete M_c as the fourth dependent-object definition after v8.151 Pi_obs completion while preserving zero claims for R_A, Traj_A, all-dependent-object completion, bundle integration, full formalization, theorem, proof, validation, readiness, and citations?")
    print("Title: Controlled M_c Definition Completion Execution v8.152")
    ...
    print("Passed: True")
    print(
        "Interpretation: The v8.152 artifact executes controlled M_c definition completion while preserving zero counts for R_A, Traj_A, all-dependent-object completion, bundle integration, full formalization, theorem candidate planning, theorem proof, validation, readiness approval, and citation claims."
    )
    print("Experiment 232 completed successfully.")
    print("V8_152_CONTROLLED_M_C_DEFINITION_COMPLETION_EXECUTION_OK")
    return 0
