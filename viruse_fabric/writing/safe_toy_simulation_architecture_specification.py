...
class SafeToySimulationArchitectureResult:
    report: str
...
def build_report(source_text: str) -> SafeToySimulationArchitectureResult:
    ...
    warnings = [
        "This milestone specifies architecture only; it does not implement simulator code.",
        "All simulation content remains toy, synthetic, unitless, abstract, and non-operational.",
    ...
    return SafeToySimulationArchitectureResult(
        report=report,
...
def write_report(source_path: Path, output_path: Path) -> SafeToySimulationArchitectureResult:
