...
class TC001ActualPresentationDeckDraftResult:
    report: str
...
def build_report(source_text: str) -> TC001ActualPresentationDeckDraftResult:
    ...
    warnings = [
        "This milestone drafts presentation content only; it does not create a new proof.",
    ...
    return TC001ActualPresentationDeckDraftResult(
        report=report,
...
def write_report(source_path: Path, output_path: Path) -> TC001ActualPresentationDeckDraftResult:
