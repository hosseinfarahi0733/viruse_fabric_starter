...
def build_report(source_text: str) -> L006ProofStrategyResult:
    ...
    prohibited_phrases = [
        "This milestone proves L-006",
        "This milestone executes L-006 proof",
    ...
    boundary_keywords = [
        "does not prove l-006",
        "does not execute l-006 proof",
    ...
    warnings = [
        "This milestone plans L-006 proof strategy only.",
        "The existing L-001, L-002, L-003, L-004, and L-005 proofs remain the only internal lemma proofs.",
        "L-006 proof execution remains zero.",
    ...
    return L006ProofStrategyResult(
        report=report,
...
def write_report(source_path: Path, output_path: Path) -> L006ProofStrategyResult:
