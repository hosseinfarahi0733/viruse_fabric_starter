...
COUNTERS = {
    "controlled_l_003_lemma_proof_strategy_planning_count": 1,
    "new_controlled_l_003_lemma_proof_strategy_planning_count": 1,
    "l_003_lemma_proof_strategy_planning_count": 1,
    "selected_lemma_count": 1,
    "selected_l_003_count": 1,
    "planned_l_003_proof_strategy_count": 1,
    "planned_l_003_proof_step_count": 6,
    ...
    "proved_l_003_lemma_count": 0,
    "proved_tc_001_supporting_lemma_count": 2,
    "internal_lemma_proof_count": 2,

    "new_l_003_lemma_proof_execution_count": 0,
    "l_003_lemma_proof_execution_count": 0,
    ...
    "imported_controlled_l_002_lemma_proof_execution_count": 1,
    "imported_l_002_lemma_proof_execution_count": 1,
    "imported_new_l_002_lemma_proof_execution_count": 1,
    "imported_lemma_proof_execution_count": 2,
    "imported_tc_001_lemma_proof_execution_count": 2,
    "imported_proved_l_001_lemma_count": 1,
    "imported_proved_l_002_lemma_count": 1,
    "imported_proved_tc_001_supporting_lemma_count": 2,
    "imported_internal_lemma_proof_count": 2,
...
LABEL_OVERRIDES = {
    "controlled_l_003_lemma_proof_strategy_planning_count": "Controlled L-003 lemma proof strategy planning count",
    "new_controlled_l_003_lemma_proof_strategy_planning_count": "New controlled L-003 lemma proof strategy planning count",
    "l_003_lemma_proof_strategy_planning_count": "L-003 lemma proof strategy planning count",
    "selected_lemma_count": "Selected lemma count",
    "selected_l_003_count": "Selected L-003 count",
    "planned_l_003_proof_strategy_count": "Planned L-003 proof strategy count",
    "planned_l_003_proof_step_count": "Planned L-003 proof step count",
    ...
    "new_l_003_lemma_proof_execution_count": "New L-003 lemma proof execution count",
    ...
    "imported_controlled_l_002_lemma_proof_execution_count": "Imported controlled L-002 lemma proof execution count",
    "imported_l_002_lemma_proof_execution_count": "Imported L-002 lemma proof execution count",
    "imported_new_l_002_lemma_proof_execution_count": "Imported new L-002 lemma proof execution count",
...
def build_report(source_text: str) -> L003ProofStrategyResult:
    ...
    prohibited_phrases = [
        "This milestone proves L-003",
        "This milestone executes L-003 proof",
    ...
    boundary_keywords = [
        "does not prove l-003",
        "does not execute l-003 proof",
    ...
    warnings = [
        "This milestone plans L-003 proof strategy only.",
        "The existing L-001 and L-002 proofs remain the only internal lemma proofs.",
        "L-003 proof execution remains zero.",
    ...
    return L003ProofStrategyResult(
        report=report,
...
def write_report(source_path: Path, output_path: Path) -> L003ProofStrategyResult:
