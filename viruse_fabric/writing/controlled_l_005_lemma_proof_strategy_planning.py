...
COUNTERS = {
    ...
    "new_controlled_l_005_lemma_proof_strategy_planning_count": 1,
    ...
    "lemma_proof_execution_count": 4,
    "tc_001_lemma_proof_execution_count": 4,
    "proved_l_001_lemma_count": 1,
    "proved_l_002_lemma_count": 1,
    "proved_l_003_lemma_count": 1,
    "proved_l_004_lemma_count": 1,
    "proved_l_005_lemma_count": 0,
    "proved_tc_001_supporting_lemma_count": 4,
    "internal_lemma_proof_count": 4,

    "new_l_005_lemma_proof_execution_count": 0,
    "l_005_lemma_proof_execution_count": 0,
    "new_lemma_proof_execution_count": 0,

    "controlled_l_004_lemma_proof_execution_count": 1,
    "new_controlled_l_004_lemma_proof_execution_count": 1,
    ...
    "imported_controlled_l_004_lemma_proof_execution_count": 1,
    "imported_l_004_lemma_proof_execution_count": 1,
    "imported_new_l_004_lemma_proof_execution_count": 1,
    ...
    "imported_executed_l_004_proof_step_count": 7,
...
LABEL_OVERRIDES = {
    ...
    "new_controlled_l_005_lemma_proof_strategy_planning_count": "New controlled L-005 lemma proof strategy planning count",
    ...
    "new_controlled_l_004_lemma_proof_execution_count": "New controlled L-004 lemma proof execution count",
    ...
    "imported_controlled_l_004_lemma_proof_execution_count": "Imported controlled L-004 lemma proof execution count",
    "imported_l_004_lemma_proof_execution_count": "Imported L-004 lemma proof execution count",
    "imported_new_l_004_lemma_proof_execution_count": "Imported new L-004 lemma proof execution count",
    ...
    "imported_executed_l_004_proof_step_count": "Imported executed L-004 proof step count",
...
def _strategy_block() -> str:
    return dedent(
        ...
        Selected lemma: `L-005 - Pi_obs codomain well-typing lemma`
        ...
        This milestone plans the proof strategy only. It does not prove L-005.

        ## Controlled proof strategy for L-005
        ...
        - v8.159 L-005 lemma plan;
        - no L-005 proof execution;
        ...
        L005-S01 - Import L-001 carrier availability
        ...
        L005-S02 - Import L-002 admissible-state typing
        ...
        L005-S03 - Import L-003 regular-transition typing
        ...
        L005-S04 - Import L-004 projection-domain compatibility

        Purpose:
        Plan the route for using official L-004 as the domain-compatibility proof that permits application of `Pi_obs`.

        Status:
        - planned only
        - not executed

        L005-S05 - Identify completed Pi_obs codomain record

        Purpose:
        Establish that completed `Pi_obs` supplies the observation codomain required for TC-001.

        Status:
        - planned only
        - not executed

        L005-S06 - Bind projected observation to Pi_obs codomain

        Purpose:
        Plan the route for showing that the result of applying `Pi_obs` to the admissible regular input is well-typed in the stated observation codomain.

        Status:
        - planned only
        - not executed

        L005-S07 - Check no disallowed dependency enters L-005

        Purpose:
        Ensure the future L-005 proof route does not depend on `M_c`, `R_A`, `Traj_A`, TC-001 proof execution, theorem proof execution, proof assistant verification, validation, manuscript readiness, or citation additions.
        ...
        This milestone plans a proof strategy for L-005.

        It does not prove L-005.

        It does not execute L-005 proof.
...
def _next_steps() -> str:
    return "\n".join(
        [
            "1. Execute controlled L-005 lemma proof only after this strategy is official.",
            "2. Keep TC-001 theorem proof separate from L-005 lemma proof execution.",
            "3. Keep proof assistant verification, validation, manuscript readiness, and citation work out of L-005 proof execution.",
        ]
    )


def build_report(source_text: str) -> L005ProofStrategyResult:
    ...
    report = dedent(
        ...
        Can Viruse Fabric select L-005 from the TC-001 lemma plan and produce a controlled proof strategy for L-005 while preserving the official L-001, L-002, L-003, and L-004 internal lemma proofs and keeping new L-005 proof execution, TC-001 proof execution, theorem proof execution, proof assistant verification, validation, manuscript readiness, readiness approval, and new citations at zero?

        ## Source artifact

        - `outputs/controlled_l_004_lemma_proof_execution_v8_167.md`

        ## Planning interpretation

        v8.168 selects L-005 and plans a controlled proof strategy for it.

        This milestone preserves the existing official L-001, L-002, L-003, and L-004 internal lemma proofs.
        ...
        This milestone plans the proof strategy for L-005 only.

        This milestone records selected L-005 count: 1.

        This milestone records planned L-005 proof strategy count: 1.

        This milestone records planned L-005 proof step count: 7.
        ...
        This milestone preserves lemma proof execution count: 4.
        ...
        This milestone preserves proved TC-001 supporting lemma count: 4.

        This milestone records L-005 lemma proof execution count: 0.

        This milestone records new L-005 lemma proof execution count: 0.

        This milestone records proved L-005 lemma count: 0.

        This milestone does not prove L-005.

        This milestone does not execute L-005 proof.
        ...
        The project has selected L-005 and planned a controlled proof strategy with seven planned proof steps while preserving the official L-001, L-002, L-003, and L-004 internal lemma proofs and keeping new L-005 proof execution, TC-001 proof execution, theorem proof execution, proof assistant verification, external validation, independent experiment, manuscript readiness, readiness approval, and new citations at zero.
        """
    ).strip() + "\n"
    ...
    prohibited_phrases = [
        "This milestone proves L-005",
        "This milestone executes L-005 proof",
    ...
    boundary_keywords = [
        "does not prove l-005",
        "does not execute l-005 proof",
    ...
    warnings = [
        "This milestone plans L-005 proof strategy only.",
        "The existing L-001, L-002, L-003, and L-004 proofs remain the only internal lemma proofs.",
        "L-005 proof execution remains zero.",
    ...
    return L005ProofStrategyResult(
        report=report,
...
def write_report(source_path: Path, output_path: Path) -> L005ProofStrategyResult:
