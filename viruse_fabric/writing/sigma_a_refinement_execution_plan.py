...
class SigmaARefinementExecutionPlanReport:
...
class SigmaARefinementExecutionPlanBuilder:
    """Build v8.134 Sigma_A refinement execution plan artifact.

    Boundary discipline:
    - This milestone plans Sigma_A refinement execution only.
    ...
    title = "Sigma_A Refinement Execution Plan v8.134"
    source_artifact = Path("outputs/time_index_refinement_boundary_audit_v8_133.md")
    output_path = Path("outputs/sigma_a_refinement_execution_plan_v8_134.md")

    plan_rows = [
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-001",
            "planned_focus": "Sigma_A refinement scope",
            "planned_action": "plan a future Sigma_A refinement layer over the assembled Draft Sigma_A shell",
            "required_precondition": "v8.133 time-index refinement boundary audit must remain clean",
            "blocked_overreach": "do not execute Sigma_A refinement in v8.134",
        },
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-002",
            "planned_focus": "time-index integration",
            "planned_action": "plan how the audited T_A/time-index refinement layer will be integrated into future Sigma_A refinement",
            "required_precondition": "carried T_A refinement execution count remains exactly one",
            "blocked_overreach": "do not execute new time-index refinement",
        },
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-003",
            "planned_focus": "draft shell preservation",
            "planned_action": "plan Sigma_A refinement without reassembling the whole Draft Sigma_A shell",
            "required_precondition": "assembled Draft Sigma_A shell remains carried and audited",
            "blocked_overreach": "do not execute new whole Sigma_A draft assembly",
        },
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-004",
            "planned_focus": "carrier-clause preservation",
            "planned_action": "plan Sigma_A refinement while preserving carrier(Draft Sigma_A) := X_A^tp",
            "required_precondition": "carrier-slot clause remains unchanged",
            "blocked_overreach": "do not create a new Sigma_A draft clause",
        },
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-005",
            "planned_focus": "dependent-object integration schedule",
            "planned_action": "plan future integration of Adm_A, C_reg, Pi_obs, M_c, R_A, and Traj_A without defining them",
            "required_precondition": "dependent-object slots remain deferred",
            "blocked_overreach": "do not execute definitions",
        },
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-006",
            "planned_focus": "definition boundary",
            "planned_action": "keep Sigma_A refinement planning separate from Sigma_A definition completion",
            "required_precondition": "formal definitions remain incomplete",
            "blocked_overreach": "do not complete Sigma_A and do not complete formal definitions",
        },
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-007",
            "planned_focus": "audit traceability",
            "planned_action": "plan Ann_A traceability for future Sigma_A refinement audit",
            "required_precondition": "Ann_A remains auxiliary audit traceability only",
            "blocked_overreach": "do not add hidden mathematical structure",
        },
        {
            "plan_id": "SIGMA-A-REFINE-PLAN-008",
            "planned_focus": "proof-readiness separation",
            "planned_action": "preserve theorem/proof/validation/readiness as downstream layers",
            "required_precondition": "Sigma_A refinement planning must not imply proof readiness",
            "blocked_overreach": "do not create theorem candidates, proofs, validation, citations, or readiness approval",
        },
    ]

    execution_gates = [
        "Future Sigma_A refinement must operate over the assembled Draft Sigma_A shell only.",
        "Future Sigma_A refinement must integrate the carried T_A/time-index layer without executing new time-index refinement.",
        "Future Sigma_A refinement must preserve carrier(Draft Sigma_A) := X_A^tp unless a separate carrier-refinement milestone is opened.",
        "Future Sigma_A refinement must keep Adm_A, C_reg, Pi_obs, M_c, R_A, and Traj_A deferred unless separate definition milestones are opened.",
        "Future Sigma_A refinement must remain separate from definition execution.",
        "Future Sigma_A refinement must not complete Sigma_A.",
        "Future Sigma_A refinement must preserve Ann_A as auxiliary audit traceability only.",
        "Future Sigma_A refinement must not create theorem candidates, proofs, validation, citations, or readiness approval.",
    ]

    def run(self) -> SigmaARefinementExecutionPlanReport:
        errors: list[str] = []
        warnings: list[str] = []
        ...
        warnings.extend([
            "This milestone plans Sigma_A refinement execution only.",
            "Sigma_A refinement execution remains zero in v8.134.",
            "No new time-index refinement and no new T_A refinement are executed in v8.134.",
        ...
        counts: dict[str, int] = {
            ...
            "sigma_a_refinement_execution_plan_count": 1,
            "sigma_a_refinement_plan_count": 1,
            "draft_sigma_a_refinement_execution_plan_count": 1,
            "sigma_a_refinement_plan_row_count": len(self.plan_rows),
            "sigma_a_refinement_execution_gate_count": len(self.execution_gates),
            "planned_sigma_a_refinement_scope_count": 1,
            "planned_time_index_layer_integration_count": 1,
            "planned_draft_shell_refinement_link_count": 1,
            "planned_carrier_clause_preservation_count": 1,
            "planned_dependent_object_integration_schedule_count": 6,
            "planned_sigma_a_boundary_guard_count": len(self.plan_rows),
            "planned_sigma_a_blocked_overreach_count": len(self.plan_rows),
            "carried_time_index_refinement_boundary_audit_count": carried.get("Time-index refinement boundary audit count", 1),
            "carried_t_a_refinement_boundary_audit_count": carried.get("T_A refinement boundary audit count", 1),
            "carried_sigma_a_time_index_refinement_boundary_audit_count": carried.get("Sigma_A time-index refinement boundary audit count", 1),
            "carried_time_index_refinement_boundary_audit_row_count": carried.get("Time-index refinement boundary audit row count", 8),
            "carried_time_index_refinement_boundary_preserved_count": carried.get("Time-index refinement boundary preserved count", 8),
            "carried_time_index_refinement_boundary_audit_finding_count": carried.get("Time-index refinement boundary audit finding count", 8),
            "carried_executed_time_index_refinement_audited_count": carried.get("Executed time-index refinement audited count", 1),
            "carried_executed_t_a_refinement_audited_count": carried.get("Executed T_A refinement audited count", 1),
            "carried_three_time_structure_audited_count": carried.get("Three-time structure audited count", 1),
            "carried_draft_shell_time_index_link_audited_count": carried.get("Draft shell time-index link audited count", 1),
            "carried_carrier_clause_preservation_audited_count": carried.get("Carrier clause preservation audited count", 1),
            "carried_dependent_object_deferral_preserved_count": carried.get("Dependent object deferral preserved count", 6),
            "carried_audit_traceability_audited_count": carried.get("Audit traceability audited count", 1),
            "carried_new_time_index_refinement_execution_blocker_count": carried.get("New time-index refinement execution blocker count", 1),
            "carried_new_t_a_refinement_execution_blocker_count": carried.get("New T_A refinement execution blocker count", 1),
            ...
            "carried_executed_time_index_refinement_layer_count": carried.get("Carried executed time-index refinement layer count", 1),
            "carried_executed_t_a_refinement_layer_count": carried.get("Carried executed T_A refinement layer count", 1),
            "carried_three_time_structure_refined_count": carried.get("Carried three-time structure refined count", 1),
        ...
        if counts["overclaim_count"] != 0:
            errors.append("Overclaim detected in v8.134 report.")
        if counts["invented_citation_like_pattern_count"] != 0:
            errors.append("Invented citation-like pattern detected in v8.134 report.")
        if counts["sigma_a_refinement_execution_plan_count"] != 1:
            errors.append("v8.134 must produce exactly one Sigma_A refinement execution plan.")
        if counts["sigma_a_refinement_plan_row_count"] != 8:
            errors.append("v8.134 must include exactly eight Sigma_A refinement plan rows.")
        if counts["sigma_a_refinement_execution_gate_count"] != 8:
            errors.append("v8.134 must include exactly eight Sigma_A refinement execution gates.")
        if counts["planned_time_index_layer_integration_count"] != 1:
            errors.append("v8.134 must plan exactly one time-index layer integration.")
        if counts["sigma_a_refinement_execution_count"] != 0:
            errors.append("v8.134 must not execute Sigma_A refinement.")
        if counts["new_time_index_refinement_execution_count"] != 0:
            errors.append("v8.134 must not execute new time-index refinement.")
        if counts["new_t_a_refinement_execution_count"] != 0:
            errors.append("v8.134 must not execute new T_A refinement.")
        if counts["definition_execution_count"] != 0:
            errors.append("v8.134 must not execute definitions.")
        if counts["sigma_a_definition_completion_count"] != 0:
            errors.append("v8.134 must not complete Sigma_A definition.")
        if counts["theorem_candidate_plan_count"] != 0:
            errors.append("v8.134 must not create theorem candidates.")
        if counts["new_theorem_proven_count"] != 0:
            errors.append("v8.134 must not prove a theorem.")
        ...
        return SigmaARefinementExecutionPlanReport(
            title=self.title,
    ...
    def _format_label(self, key: str) -> str:
        overrides = {
            "sigma_a_refinement_execution_plan_count": "Sigma_A refinement execution plan count",
            "sigma_a_refinement_plan_count": "Sigma_A refinement plan count",
            "draft_sigma_a_refinement_execution_plan_count": "Draft Sigma_A refinement execution plan count",
            "sigma_a_refinement_plan_row_count": "Sigma_A refinement plan row count",
            "sigma_a_refinement_execution_gate_count": "Sigma_A refinement execution gate count",
            "planned_sigma_a_refinement_scope_count": "Planned Sigma_A refinement scope count",
            "planned_time_index_layer_integration_count": "Planned time-index layer integration count",
            "planned_draft_shell_refinement_link_count": "Planned draft shell refinement link count",
            "planned_carrier_clause_preservation_count": "Planned carrier clause preservation count",
            "planned_dependent_object_integration_schedule_count": "Planned dependent object integration schedule count",
            "planned_sigma_a_boundary_guard_count": "Planned Sigma_A boundary guard count",
            "planned_sigma_a_blocked_overreach_count": "Planned Sigma_A blocked-overreach count",
            ...
            "carried_time_index_refinement_boundary_audit_row_count": "Carried time-index refinement boundary audit row count",
            "carried_time_index_refinement_boundary_preserved_count": "Carried time-index refinement boundary preserved count",
            "carried_time_index_refinement_boundary_audit_finding_count": "Carried time-index refinement boundary audit finding count",
            ...
            "carried_draft_shell_time_index_link_audited_count": "Carried draft shell time-index link audited count",
            "carried_carrier_clause_preservation_audited_count": "Carried carrier clause preservation audited count",
            "carried_dependent_object_deferral_preserved_count": "Carried dependent object deferral preserved count",
            "carried_audit_traceability_audited_count": "Carried audit traceability audited count",
            "carried_new_time_index_refinement_execution_blocker_count": "Carried new time-index refinement execution blocker count",
            "carried_new_t_a_refinement_execution_blocker_count": "Carried new T_A refinement execution blocker count",
    ...
    def _render_report(self, counts: dict[str, int], warnings: list[str]) -> str:
        ...
        lines.append(
            "Can Viruse Fabric plan Sigma_A refinement execution after the v8.133 time-index refinement boundary audit while keeping actual Sigma_A refinement, "
        ...
        lines.append("- Milestone type: Sigma_A refinement execution plan only")
        ...
        lines.append("")
        lines.append("## Sigma_A refinement plan rows")
        lines.append("")
        ...
        lines.append("")
        lines.append("## Sigma_A refinement execution gates")
        for index, gate in enumerate(self.execution_gates, start=1):
            lines.append(f"{index}. {gate}")
        lines.append("")
        lines.append("## Boundary statement")
        lines.append(
            "This artifact plans Sigma_A refinement execution only. "
            "It plans future Sigma_A refinement over the assembled Draft Sigma_A shell and the audited T_A/time-index layer, "
            "but it does not execute Sigma_A refinement, does not execute new time-index refinement, does not execute new T_A refinement, "
        ...
        counter_order = [
            "sigma_a_refinement_execution_plan_count",
            "sigma_a_refinement_plan_count",
            "draft_sigma_a_refinement_execution_plan_count",
            "sigma_a_refinement_plan_row_count",
            "sigma_a_refinement_execution_gate_count",
            "planned_sigma_a_refinement_scope_count",
            "planned_time_index_layer_integration_count",
            "planned_draft_shell_refinement_link_count",
            "planned_carrier_clause_preservation_count",
            "planned_dependent_object_integration_schedule_count",
            "planned_sigma_a_boundary_guard_count",
            "planned_sigma_a_blocked_overreach_count",
            ...
            "carried_time_index_refinement_boundary_audit_row_count",
            "carried_time_index_refinement_boundary_preserved_count",
            "carried_time_index_refinement_boundary_audit_finding_count",
            ...
            "carried_draft_shell_time_index_link_audited_count",
            "carried_carrier_clause_preservation_audited_count",
            "carried_dependent_object_deferral_preserved_count",
            "carried_audit_traceability_audited_count",
            "carried_new_time_index_refinement_execution_blocker_count",
            "carried_new_t_a_refinement_execution_blocker_count",
        ...
        lines.append(
            "The v8.134 artifact plans Sigma_A refinement execution after the audited bounded time-index refinement. "
            "It plans future integration of the T_A/time-index layer into a Sigma_A refinement layer, but it does not execute Sigma_A refinement, "
            "does not execute new time-index refinement, does not execute definitions, does not complete Sigma_A, does not create theorem candidates, "
            "does not prove theorems, does not provide proof assistant verification, does not provide external validation, and does not approve manuscript readiness."
        )
        lines.append("")
        lines.append("## Next steps")
        next_steps = [
            "Audit the Sigma_A refinement execution plan before executing Sigma_A refinement.",
...
if __name__ == "__main__":
    report = SigmaARefinementExecutionPlanBuilder().run()
