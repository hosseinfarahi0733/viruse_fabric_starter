...
Required source artifact count: 61
...
- hard_zero: controlled_formal_definition_completion_attempt_execution_count: 0
...
- boundary_phrase: controlled formal definition completion attempt plan exists
- boundary_phrase: completion attempt planning is not completion attempt execution
- boundary_phrase: completion attempt planning is not formal definition completion
- boundary_phrase: formal definition execution exists as source status
- boundary_phrase: completion readiness decision execution exists as source status
...
- prohibited_behavior: Do not claim controlled formal definition completion attempt execution.
...
- next_step: Execute controlled formal definition completion attempt in a future milestone.
- next_step: Keep completed formal definitions at zero until a dedicated completion milestone.
- next_step: Separate completion attempt planning from completion attempt execution.
- next_step: Separate completion attempt execution from completed formal definitions.
...
- next_step: Do not execute a proof inside this completion-attempt-plan milestone.
