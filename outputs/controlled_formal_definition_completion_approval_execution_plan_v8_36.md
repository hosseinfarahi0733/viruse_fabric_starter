...
Required source artifact count: 66
...
- hard_zero: formal_definition_completion_approval_execution_count: 0
- hard_zero: formal_definition_completion_approved_count: 0
...
- boundary_phrase: controlled formal definition completion approval execution plan exists
- boundary_phrase: completion approval execution planning is not completion approval execution
- boundary_phrase: completion approval execution planning is not formal definition completion approval
- boundary_phrase: completion approval execution planning is not completed formal definition
- boundary_phrase: completion approval decision execution exists as source status
- boundary_phrase: completion approval decision execution is not completion approval execution
- boundary_phrase: completion approval plan exists as source status
- boundary_phrase: completion attempt execution exists as source status
- boundary_phrase: formal definition execution exists as source status
- boundary_phrase: formal definition completion approval does not exist
...
- prohibited_behavior: Do not claim completion approval execution.
- prohibited_behavior: Do not claim formal definition completion approval.
...
- next_step: Execute controlled formal definition completion approval in a future milestone.
- next_step: Keep completion approval execution at zero until a dedicated approval execution milestone.
- next_step: Keep completed formal definitions at zero until a dedicated completion approval milestone.
- next_step: Separate completion approval execution planning from completion approval execution.
...
- next_step: Do not execute a proof inside this completion-approval-execution-plan milestone.
