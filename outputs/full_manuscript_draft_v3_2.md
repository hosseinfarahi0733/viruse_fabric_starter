# Viruse Fabric Full Manuscript Draft v3.2

## Manuscript Status

Status: full manuscript draft for cautious technical review
...
- `outputs/theory_manifest_v2_0.md` | exists: True
- `outputs/validation_protocol_v2_4.md` | exists: True
- `outputs/constructive_attractor_ablation_v2_5.md` | exists: True
- `outputs/parameter_sensitivity_v2_6.md` | exists: True
- `outputs/adversarial_sensitivity_v2_7.md` | exists: True
- `outputs/baseline_comparison_v2_8.md` | exists: True
- `outputs/projection_perturbation_v2_9.md` | exists: True
- `outputs/validation_synthesis_v3_0.md` | exists: True
- `outputs/manuscript_skeleton_v3_1.md` | exists: True
