...
Required source artifact count: 45
...
- hard_zero: controlled_checklist_completion_attempt_execution_count: 0
...
- boundary_phrase: controlled checklist completion attempt plan exists
- boundary_phrase: controlled checklist completion attempt execution does not exist
...
- prohibited_behavior: Do not claim controlled checklist completion attempt execution.
...
- next_step: Execute the controlled checklist completion attempt in a future milestone.
- next_step: Keep checklist completion at zero until attempt execution is explicitly tested.
- next_step: Separate attempt planning from attempt execution.
- next_step: Separate attempt execution from completion approval.
...
- next_step: Do not execute formal definitions inside this attempt-plan milestone.
