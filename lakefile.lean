...
lean_lib VFH2 where
  ...
  roots := #[
    ...
    `VFH2.UnrestrictedBridge.CountableInfiniteActiveGlobalLedgerStrictComparison,
    `VFH2.UnrestrictedBridge.CountableInfiniteActivePersistentEphemeralTraceBridge,
  ...
  `VFH2.Product.ProductBridgeTransport,
    `VFH2.Product.ThreeTimeCausalSemanticRecovery,
    ...
    `VFH2.Product.ProductBridgeRelaxationCertificate,
    ...
    `VFH2.Product.ProductRestrictedParamsUpdateScoreTransport,
    `VFH2.Product.ProductRestrictedParamsUpdateScoreBound,
    ...
    `VFH2.Product.ProductRestrictedParamsScorePreservationDischarge,
    `VFH2.Product.ProductRestrictedParamsPolicyEndToEndScoreWindow,
    `VFH2.Product.ProductRestrictedParamsRestrictedProofSpineFreeze,
    `VFH2.Product.ProductRestrictedParamsScorePreservingPolicyInstantiation,
